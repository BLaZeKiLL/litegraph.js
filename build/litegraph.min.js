...
(function(r) {
  ...
  g.onMenuAdd = function(a, b, c, d) {
    ...
    b = [];
    for (var v in a) {
      a[v] && b.push({value:a[v], content:a[v], has_submenu:!0});
    }
    var k = new f.ContextMenu(b, {event:c, callback:function(a, b, c) {
      a = f.getNodeTypesInCategory(a.value, m.filter);
      b = [];
      for (var d in a) {
        a[d].skip_list || b.push({content:a[d].title, value:a[d].type});
      }
      new f.ContextMenu(b, {event:c, callback:e, parentMenu:k}, h);
      return !1;
    }, parentMenu:d}, h);
    return !1;
  };
