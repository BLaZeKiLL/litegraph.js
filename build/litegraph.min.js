...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(u, n, y) {
  u != Array.prototype && u != Object.prototype && (u[n] = y.value);
};
$jscomp.getGlobal = function(u) {
  return "undefined" != typeof window && window === u ? u : "undefined" != typeof global && null != global ? global : u;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(u, n, y, r) {
  if (n) {
    y = $jscomp.global;
    u = u.split(".");
    ...
    r = y[u];
    n = n(r);
    n != r && null != n && $jscomp.defineProperty(y, u, {configurable:!0, writable:!0, value:n});
  }
};
$jscomp.polyfill("Array.prototype.fill", function(u) {
  return u ? u : function(n, u, r) {
    var w = this.length || 0;
    ...
    r = Number(r);
    0 > r && (r = Math.max(0, w + r));
    for (u = Number(u || 0); u < r; u++) {
      this[u] = n;
    }
    return this;
  };
...
$jscomp.Symbol = function() {
  var u = 0;
  return function(n) {
    return $jscomp.SYMBOL_PREFIX + (n || "") + u++;
  };
}();
...
$jscomp.arrayIterator = function(u) {
  ...
  return $jscomp.iteratorPrototype(function() {
    return n < u.length ? {done:!1, value:u[n++]} : {done:!0};
  });
};
...
$jscomp.iteratorFromArray = function(u, n) {
  $jscomp.initSymbolIterator();
  u instanceof String && (u += "");
  var y = 0, r = {next:function() {
    if (y < u.length) {
      var w = y++;
      return {value:n(w, u[w]), done:!1};
    }
    r.next = function() {
...
$jscomp.polyfill("Array.prototype.values", function(u) {
  return u ? u : function() {
    return $jscomp.iteratorFromArray(this, function(n, u) {
      return u;
    });
  };
}, "es8", "es3");
...
(function(u) {
  ...
  function g(a, b, c) {
    ...
    this.onDrawLinkTooltip = this.onDrawOverlay = this.onDrawForeground = this.onDrawBackground = this.onMouse = this.onSearchBoxSelection = this.onSearchBox = null;
  ...
  function A(a, b, c, d, e, m) {
    return c < a && c + e > a && d < b && d + m > b ? !0 : !1;
  }
  function D(a, b) {
  ...
  function C(a, b) {
    function c(a) {
      ...
      e.style.top = (c + a.deltaY * b.scroll_speed).toFixed() + "px";
      a.preventDefault();
      return !0;
    }
    this.options = b = b || {};
    ...
    e.addEventListener("wheel", c, !0);
    e.addEventListener("mousewheel", c, !0);
    this.root = e;
    if (b.title) {
    ...
    m = 0;
    for (var h in a) {
      var f = a.constructor == Array ? a[h] : h;
      null != f && f.constructor !== String && (f = void 0 === f.content ? String(f) : f.content);
      this.addItem(f, a[h], b);
      m++;
    }
    e.addEventListener("mouseleave", function(a) {
      d.lock || (e.closing_timer && clearTimeout(e.closing_timer), e.closing_timer = setTimeout(d.close.bind(d, a), 500));
    });
    ...
    h = b.left || 0;
    a = b.top || 0;
    b.event && (h = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (h = b.parentMenu.root.getBoundingClientRect(), h = h.left + h.width), m = document.body.getBoundingClientRect(), f = e.getBoundingClientRect(), h > m.width - f.width - 10 && (h = m.width - f.width - 10), a > m.height - f.height - 10 && (a = m.height - f.height - 10));
    e.style.left = h + "px";
    e.style.top = a + "px";
  ...
  function G(a, b) {
    ...
    this.root = c;
    c.className = "litegraph-editor";
    c.innerHTML = "<div class='content'><div class='editor-area'><canvas class='graphcanvas' width='1000' height='500' tabindex=10></canvas></div></div>";
    this.tools = c.querySelector(".tools");
    this.footer = c.querySelector(".footer");
    var d = c.querySelector(".graphcanvas"), e = this.graph = new n, f = this.graphcanvas = new g(d, e);
    f.background_image = "assets/img/grid.png";
    e.onAfterExecute = function() {
      f.draw(!0);
    };
    b.miniwindow && this.addMiniWindow(300, 200);
    (a = document.getElementById(a)) && a.appendChild(c);
    f.resize();
  }
  ...
  node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    if (b.prototype) {
      for (var e in r.prototype) {
        b.prototype[e] || (b.prototype[e] = r.prototype[e]);
      }
    }
    ...
    d = this.registered_node_types[a];
    ...
    if (b.supported_extensions) {
      for (e in b.supported_extensions) {
        this.node_types_by_file_extension[b.supported_extensions[e].toLowerCase()] = b;
      }
    }
  }, wrapFunctionAsNode:function(a, b, c, d, e) {
    for (var m = Array(b.length), h = "", g = f.getParameterNames(b), q = 0; q < g.length; ++q) {
      h += "this.addInput('" + g[q] + "'," + (c && c[q] ? "'" + c[q] + "'" : "0") + ");\n";
    }
    ...
    for (d in this.registered_node_types) {
      ...
      b && e.filter && e.filter != b || ("" == a ? null == e.category && c.push(e) : e.category == a && c.push(e));
    }
    return c;
    ...
    for (c in this.registered_node_types) {
      var d = this.registered_node_types[c];
      !d.category || d.skip_list || a && d.filter != a || (b[d.category] = 1);
    }
    a = [];
    for (c in b) {
      a.push(c);
    ...
    var b = document.getElementsByTagName("script"), c = [], d;
    for (d in b) {
      c.push(b[d]);
    }
  ...
  u.LGraph = f.LGraph = n;
  n.supported_types = ["number", "string", "boolean"];
  n.prototype.getSupportedTypes = function() {
    return this.supported_types || n.supported_types;
  };
  n.STATUS_STOPPED = 1;
  n.STATUS_RUNNING = 2;
  n.prototype.clear = function() {
    this.stop();
    this.status = n.STATUS_STOPPED;
  ...
  n.prototype.attachCanvas = function(a) {
    if (a.constructor != g) {
  ...
  n.prototype.detachCanvas = function(a) {
  ...
  n.prototype.start = function(a) {
    if (this.status != n.STATUS_RUNNING) {
  ...
  n.prototype.stop = function() {
    if (this.status != n.STATUS_STOPPED) {
      this.status = n.STATUS_STOPPED;
      if (this.onStopEvent) {
        this.onStopEvent();
      }
  ...
  n.prototype.runStep = function(a, b, c) {
    a = a || 1;
    var d = f.getTime();
    ...
    if (e) {
      ...
      if (b) {
        for (var m = 0; m < a; m++) {
          for (var h = 0; h < c; ++h) {
            var g = e[h];
            if (g.mode == f.ALWAYS && g.onExecute) {
              g.onExecute();
            }
          }
        ...
        try {
          for (m = 0; m < a; m++) {
            for (h = 0; h < c; ++h) {
              if (g = e[h], g.mode == f.ALWAYS && g.onExecute) {
                g.onExecute();
              }
            }
            this.fixedtime += this.fixedtime_lapse;
          ...
          f.debug && console.log("Error during execution: " + q);
          this.stop();
        }
      }
      a = f.getTime();
  ...
  n.prototype.updateExecutionOrder = function() {
  ...
  n.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], d = [], e = {}, m = {}, h = {}, g = 0, q = this._nodes.length; g < q; ++g) {
      var l = this._nodes[g];
      if (!a || l.onExecute) {
        e[l.id] = l;
        var p = 0;
        if (l.inputs) {
          for (var t = 0, k = l.inputs.length; t < k; t++) {
            l.inputs[t] && null != l.inputs[t].link && (p += 1);
          }
        }
        0 == p ? (d.push(l), b && (l._level = 1)) : (b && (l._level = 0), h[l.id] = p);
      }
    }
    for (; 0 != d.length;) {
      if (l = d.shift(), c.push(l), delete e[l.id], l.outputs) {
        for (g = 0; g < l.outputs.length; g++) {
          if (a = l.outputs[g], null != a && null != a.links && 0 != a.links.length) {
            for (t = 0; t < a.links.length; t++) {
              (q = this.links[a.links[t]]) && !m[q.id] && (p = this.getNodeById(q.target_id), null == p ? m[q.id] = !0 : (b && (!p._level || p._level <= l._level) && (p._level = l._level + 1), m[q.id] = !0, --h[p.id], 0 == h[p.id] && d.push(p)));
            }
          }
        }
      }
  ...
  n.prototype.arrange = function(a) {
    ...
    for (d = 0; d < c.length; ++d) {
      if (f = c[d]) {
        for (var h = 100, g = a, q = 0; q < f.length; ++q) {
          e = f[q], e.pos[0] = b, e.pos[1] = g, e.size[0] > h && (h = e.size[0]), g += e.size[1] + a;
        }
        b += h + a;
      }
    }
  ...
  n.prototype.getFixedTime = function() {
    return this.fixedtime;
  };
  n.prototype.getElapsedTime = function() {
    return this.elapsed_time;
  };
  n.prototype.sendEventToAllNodes = function(a, b, c) {
    c = c || f.ALWAYS;
  ...
  n.prototype.sendActionToCanvas = function(a, b) {
    if (this.list_of_graphcanvas) {
  ...
  n.prototype.getNodeById = function(a) {
    return null == a ? null : this._nodes_by_id[a];
  };
  n.prototype.findNodesByClass = function(a, b) {
    b = b || [];
  ...
  n.prototype.findNodesByType = function(a, b) {
    a = a.toLowerCase();
    b = b || [];
    for (var c = b.length = 0, d = this._nodes.length; c < d; ++c) {
  ...
  n.prototype.findNodeByTitle = function(a) {
  ...
  n.prototype.findNodesByTitle = function(a) {
    for (var b = [], c = 0, d = this._nodes.length; c < d; ++c) {
      this._nodes[c].title == a && b.push(this._nodes[c]);
    }
    return b;
  };
  n.prototype.getNodeOnPos = function(a, b, c, d) {
    c = c || this._nodes;
    for (var e = c.length - 1; 0 <= e; e--) {
      var f = c[e];
      if (f.isPointInside(a, b, d)) {
        return f;
      }
    }
    return null;
  };
  n.prototype.getGroupOnPos = function(a, b) {
  ...
  n.prototype.checkNodeTypes = function() {
    for (var a = 0; a < this._nodes.length; a++) {
      var b = this._nodes[a];
  ...
  n.prototype.addInput = function(a, b, c) {
    if (!this.inputs[a]) {
  ...
  n.prototype.setInputData = function(a, b) {
    if (a = this.inputs[a]) {
      a.value = b;
    }
  };
  n.prototype.getInputData = function(a) {
    return (a = this.inputs[a]) ? a.value : null;
  };
  n.prototype.renameInput = function(a, b) {
    if (b != a) {
      if (!this.inputs[a]) {
        return !1;
      }
  ...
  n.prototype.changeInputType = function(a, b) {
    if (!this.inputs[a]) {
      return !1;
    }
  ...
  n.prototype.addOutput = function(a, b, c) {
  ...
  n.prototype.renameOutput = function(a, b) {
    if (!this.outputs[a]) {
      return !1;
    }
    if (this.outputs[b]) {
  ...
  n.prototype.changeOutputType = function(a, b) {
    if (!this.outputs[a]) {
      return !1;
    }
  ...
  n.prototype.triggerInput = function(a, b) {
    a = this.findNodesByTitle(a);
    for (var c = 0; c < a.length; ++c) {
      a[c].onTrigger(b);
    }
  };
  n.prototype.setCallback = function(a, b) {
    a = this.findNodesByTitle(a);
    for (var c = 0; c < a.length; ++c) {
      a[c].setTrigger(b);
    }
  };
  n.prototype.connectionChange = function(a, b) {
    this.updateExecutionOrder();
  ...
  n.prototype.clearTriggeredSlots = function() {
  ...
  n.prototype.removeLink = function(a) {
    if (a = this.links[a]) {
  ...
  n.prototype.serialize = function() {
    ...
    for (b = 0; b < this._groups.length; ++b) {
      d.push(this._groups[b].serialize());
    }
    return {last_node_id:this.last_node_id, last_link_id:this.last_link_id, nodes:a, links:c, groups:d, config:this.config, version:f.VERSION};
  };
  n.prototype.configure = function(a, b) {
    if (a) {
      b || this.clear();
      b = a.nodes;
      if (a.links && a.links.constructor === Array) {
        for (var c = [], d = 0; d < a.links.length; ++d) {
          var e = a.links[d], m = new y;
          m.configure(e);
          c[m.id] = m;
        }
        a.links = c;
      ...
      if (b) {
        ...
        for (e = b.length; d < e; ++d) {
          m = b[d];
          var h = f.createNode(m.type, m.title);
          h || (f.debug && console.log("Node not found or has errors: " + m.type), h = new r, h.last_serialization = m, c = h.has_errors = !0);
          h.id = m.id;
          this.add(h, !0);
        }
        d = 0;
        for (e = b.length; d < e; ++d) {
          m = b[d], (h = this.getNodeById(m.id)) && h.configure(m);
        }
      }
  ...
  n.prototype.onNodeTrace = function(a, b, c) {
  };
  ...
  r.prototype.serialize = function() {
    ...
    if (this.constructor === r && this.last_serialization) {
  ...
  r.prototype.setProperty = function(a, b) {
    this.properties || (this.properties = {});
    this.properties[a] = b;
    if (this.onPropertyChanged) {
      this.onPropertyChanged(a, b);
    }
  };
  ...
  r.prototype.setOutputDataType = function(a, b) {
    if (this.outputs && !(-1 == a || a >= this.outputs.length)) {
      var c = this.outputs[a];
  ...
  r.prototype.getInputData = function(a, b) {
  ...
  r.prototype.getInputDataType = function(a) {
    if (!this.inputs || a >= this.inputs.length || null == this.inputs[a].link) {
      return null;
    }
    a = this.graph.links[this.inputs[a].link];
  ...
  r.prototype.getInputOrProperty = function(a) {
  ...
  r.prototype.getOutputNodes = function(a) {
  ...
  r.prototype.triggerSlot = function(a, b, c) {
    if (this.outputs && (a = this.outputs[a]) && (a = a.links) && a.length) {
      this.graph && (this.graph._last_trigger_time = f.getTime());
      for (var d = 0; d < a.length; ++d) {
        var e = a[d];
        if (null == c || c == e) {
          var m = this.graph.links[a[d]];
          if (m && (m._last_time = f.getTime(), e = this.graph.getNodeById(m.target_id))) {
            if (m = e.inputs[m.target_slot], e.onAction) {
              e.onAction(m.name, b);
            } else {
              if (e.mode === f.ON_TRIGGER && e.onExecute) {
                e.onExecute(b);
              }
            }
          }
  ...
  r.prototype.clearTriggeredSlot = function(a, b) {
    if (this.outputs && (a = this.outputs[a]) && (a = a.links) && a.length) {
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (null == b || b == d) {
  ...
  r.prototype.addProperty = function(a, b, c, d) {
  ...
  r.prototype.addOutputs = function(a) {
  ...
  r.prototype.addInputs = function(a) {
    for (var b = 0; b < a.length; ++b) {
      var c = a[b], d = {name:c[0], type:c[1], link:null};
      if (a[2]) {
        for (var e in c[2]) {
  ...
  r.prototype.addConnection = function(a, b, c, d) {
    a = {name:a, type:b, pos:c, direction:d, links:null};
    this.connections.push(a);
    return a;
  };
  r.prototype.computeSize = function(a, b) {
    function c(a) {
    ...
    a = Math.max(a, 1);
    var d = f.NODE_TEXT_SIZE;
    b[1] = (this.constructor.slot_start_y || 0) + a * f.NODE_SLOT_HEIGHT;
    a = 0;
    this.widgets && this.widgets.length && (a = this.widgets.length * (f.NODE_WIDGET_HEIGHT + 4) + 8);
    b[1] = this.widgets_up ? Math.max(b[1], a) : b[1] + a;
    a = c(this.title);
    var e = 0, m = 0;
    if (this.inputs) {
      for (var h = 0, g = this.inputs.length; h < g; ++h) {
        var q = this.inputs[h];
        q = q.label || q.name || "";
        q = c(q);
        e < q && (e = q);
    ...
    if (this.outputs) {
      for (h = 0, g = this.outputs.length; h < g; ++h) {
        q = this.outputs[h], q = q.label || q.name || "", q = c(q), m < q && (m = q);
      }
    }
    b[0] = Math.max(e + m + 10, a);
    b[0] = Math.max(b[0], f.NODE_WIDTH);
    this.widgets && this.widgets.length && (b[0] = Math.max(b[0], 1.5 * f.NODE_WIDTH));
    if (this.onResize) {
      this.onResize(b);
    }
  ...
  r.prototype.addCustomWidget = function(a) {
    this.widgets || (this.widgets = []);
    this.widgets.push(a);
    return a;
  };
  r.prototype.getBounding = function(a) {
  ...
  r.prototype.isPointInside = function(a, b, c, d) {
    c = c || 0;
    var e = this.graph && this.graph.isLive() ? 0 : f.NODE_TITLE_HEIGHT;
    d && (e = 0);
    if (this.flags && this.flags.collapsed) {
      if (A(a, b, this.pos[0] - c, this.pos[1] - f.NODE_TITLE_HEIGHT - c, (this._collapsed_width || f.NODE_COLLAPSED_WIDTH) + 2 * c, f.NODE_TITLE_HEIGHT + 2 * c)) {
        return !0;
      }
    } else {
  ...
  r.prototype.getSlotInPosition = function(a, b) {
    ...
    if (this.inputs) {
      for (var d = 0, e = this.inputs.length; d < e; ++d) {
        ...
        if (A(a, b, c[0] - 10, c[1] - 5, 20, 10)) {
          return {input:f, slot:d, link_pos:c};
        }
      }
    }
    if (this.outputs) {
      for (d = 0, e = this.outputs.length; d < e; ++d) {
        if (f = this.outputs[d], this.getConnectionPos(!1, d, c), A(a, b, c[0] - 10, c[1] - 5, 20, 10)) {
          return {output:f, slot:d, link_pos:c};
        }
      }
    }
    return null;
  };
  r.prototype.findInputSlot = function(a) {
    if (!this.inputs) {
      return -1;
    }
    for (var b = 0, c = this.inputs.length; b < c; ++b) {
  ...
  r.prototype.findOutputSlot = function(a) {
    if (!this.outputs) {
      return -1;
    }
  ...
  r.prototype.connect = function(a, b, c) {
    c = c || 0;
    if (!this.graph) {
    ...
    if (b.onConnectInput && !1 === b.onConnectInput(c, d.type, d)) {
      return null;
    }
    var e = b.inputs[c], m = null;
    if (f.isValidConnection(d.type, e.type)) {
      m = new y(this.graph.last_link_id++, e.type, this.id, a, b.id, c);
      this.graph.links[m.id] = m;
      null == d.links && (d.links = []);
      d.links.push(m.id);
      b.inputs[c].link = m.id;
      this.graph && this.graph._version++;
      if (this.onConnectionsChange) {
        this.onConnectionsChange(f.OUTPUT, a, !0, m, d);
      }
      if (b.onConnectionsChange) {
        b.onConnectionsChange(f.INPUT, c, !0, m, e);
      }
    ...
    this.graph.connectionChange(this, m);
    return m;
  };
  r.prototype.disconnectOutput = function(a, b) {
    if (a.constructor === String) {
      if (a = this.findOutputSlot(a), -1 == a) {
    ...
    if (b) {
      ...
      for (var d = 0, e = c.links.length; d < e; d++) {
        var m = c.links[d], h = this.graph.links[m];
        if (h.target_id == b.id) {
          c.links.splice(d, 1);
          var g = b.inputs[h.target_slot];
          g.link = null;
          delete this.graph.links[m];
          this.graph && this.graph._version++;
          if (b.onConnectionsChange) {
            b.onConnectionsChange(f.INPUT, h.target_slot, !1, h, g);
          }
          if (this.onConnectionsChange) {
      ...
      for (e = c.links.length; d < e; d++) {
        if (m = c.links[d], h = this.graph.links[m]) {
          b = this.graph.getNodeById(h.target_id);
          this.graph && this.graph._version++;
          if (b) {
            g = b.inputs[h.target_slot];
            g.link = null;
            if (b.onConnectionsChange) {
              b.onConnectionsChange(f.INPUT, h.target_slot, !1, h, g);
            }
  ...
  r.prototype.disconnectInput = function(a) {
    if (a.constructor === String) {
    ...
    if (d) {
      ...
      var m = e.outputs[d.origin_slot];
      if (!m || !m.links || 0 == m.links.length) {
        return !1;
      }
      for (var h = 0, g = m.links.length; h < g; h++) {
        if (m.links[h] == c) {
          m.links.splice(h, 1);
          break;
        }
      ...
      if (e.onConnectionsChange) {
        e.onConnectionsChange(f.OUTPUT, h, !1, d, m);
      }
  ...
  r.prototype.getConnectionPos = function(a, b, c) {
  ...
  r.prototype.alignToGrid = function() {
  ...
  r.prototype.trace = function(a) {
    ...
    this.console.push(a);
    this.console.length > r.MAX_CONSOLE && this.console.shift();
  ...
  r.prototype.captureInput = function(a) {
  ...
  r.prototype.pin = function(a) {
    this.graph._version++;
    this.flags.pinned = void 0 === a ? !this.flags.pinned : a;
  };
  r.prototype.localToScreen = function(a, b, c) {
    return [(a + this.pos[0]) * c.scale + c.offset[0], (b + this.pos[1]) * c.scale + c.offset[1]];
  };
  u.LGraphGroup = f.LGraphGroup = w;
  w.prototype._ctor = function(a) {
    this.title = a || "Group";
    this.font_size = 24;
  ...
  w.prototype.move = function(a, b, c) {
    this._pos[0] += a;
    this._pos[1] += b;
    if (!c) {
  ...
  w.prototype.recomputeInsideNodes = function() {
    this._nodes.length = 0;
    for (var a = this.graph._nodes, b = new Float32Array(4), c = 0; c < a.length; ++c) {
      var d = a[c];
      d.getBounding(b);
      D(this._bounding, b) && this._nodes.push(d);
    }
  };
  w.prototype.isPointInside = r.prototype.isPointInside;
  w.prototype.setDirtyCanvas = r.prototype.setDirtyCanvas;
  f.DragAndScale = k;
  k.prototype.bindEvents = function(a) {
  ...
  k.prototype.computeVisibleArea = function() {
    if (this.element) {
  ...
  k.prototype.onMouse = function(a) {
    if (this.enabled) {
  ...
  k.prototype.toCanvasContext = function(a) {
    a.scale(this.scale, this.scale);
    a.translate(this.offset[0], this.offset[1]);
  };
  k.prototype.convertOffsetToCanvas = function(a) {
  ...
  k.prototype.mouseDrag = function(a, b) {
  ...
  k.prototype.changeScale = function(a, b) {
  ...
  k.prototype.changeDeltaScale = function(a, b) {
  ...
  u.LGraphCanvas = f.LGraphCanvas = g;
  g.link_type_colors = {"-1":f.EVENT_LINK_COLOR, number:"#AAA", node:"#DCA"};
  g.gradients = {};
  ...
  g.prototype.processMouseDown = function(a) {
    if (this.graph) {
      ...
      var c = this.graph.getNodeOnPos(a.canvasX, a.canvasY, this.visible_nodes, 5), d = !1, e = 300 > f.getTime() - this.last_mouseclick;
      ...
      if (!this.onMouse || 1 != this.onMouse(a)) {
        if (1 == a.which) {
          ...
          var m = !1;
          if (c && this.allow_interaction && !d && !this.read_only) {
            this.live_mode || c.flags.pinned || this.bringToFront(c);
            if (!this.connecting_node && !c.flags.collapsed && !this.live_mode) {
              if (!d && !1 !== c.resizable && A(a.canvasX, a.canvasY, c.pos[0] + c.size[0] - 5, c.pos[1] + c.size[1] - 5, 10, 10)) {
                this.resizing_node = c, this.canvas.style.cursor = "se-resize", d = !0;
              } else {
                if (c.outputs) {
                  for (var h = 0, v = c.outputs.length; h < v; ++h) {
                    var q = c.outputs[h], l = c.getConnectionPos(!1, h);
                    if (A(a.canvasX, a.canvasY, l[0] - 15, l[1] - 10, 30, 20)) {
                      this.connecting_node = c;
                      this.connecting_output = q;
                      this.connecting_pos = c.getConnectionPos(!1, h);
                      this.connecting_slot = h;
                      a.shiftKey && c.disconnectOutput(h);
                      if (e) {
                        if (c.onOutputDblClick) {
                          c.onOutputDblClick(h, a);
                        }
                      } else {
                        if (c.onOutputClick) {
                          c.onOutputClick(h, a);
                ...
                if (c.inputs) {
                  for (h = 0, v = c.inputs.length; h < v; ++h) {
                    if (q = c.inputs[h], l = c.getConnectionPos(!0, h), A(a.canvasX, a.canvasY, l[0] - 15, l[1] - 10, 30, 20)) {
                      if (e) {
                        if (c.onInputDblClick) {
                          c.onInputDblClick(h, a);
                        }
                      } else {
                        if (c.onInputClick) {
                          c.onInputClick(h, a);
                      ...
                      if (null !== q.link) {
                        d = this.graph.links[q.link];
                        c.disconnectInput(h);
                        if (this.allow_reconnect_links || a.shiftKey) {
                          this.connecting_node = this.graph._nodes_by_id[d.origin_id], this.connecting_slot = d.origin_slot, this.connecting_output = this.connecting_node.outputs[this.connecting_slot], this.connecting_pos = this.connecting_node.getConnectionPos(!1, this.connecting_slot);
                        }
            ...
            if (!d) {
              h = !1;
              if (v = this.processNodeWidgets(c, this.canvas_mouse, a)) {
                h = !0, this.node_widget = [c, v];
              }
              if (e && this.selected_nodes[c.id]) {
                if (c.onDblClick) {
              ...
              c.onMouseDown && c.onMouseDown(a, [a.canvasX - c.pos[0], a.canvasY - c.pos[1]], this) ? h = !0 : this.live_mode && (h = m = !0);
              h || (this.allow_dragnodes && (this.node_dragged = c), this.selected_nodes[c.id] || this.processNodeSelected(c, a));
              this.dirty_canvas = !0;
            }
          } else {
            if (!this.read_only) {
              for (h = 0; h < this.visible_links.length; ++h) {
                if (c = this.visible_links[h], m = c._pos, !(!m || a.canvasX < m[0] - 4 || a.canvasX > m[0] + 4 || a.canvasY < m[1] - 4 || a.canvasY > m[1] + 4)) {
            ...
            this.selected_group && !this.read_only && (a.ctrlKey && (this.dragging_rectangle = null), 10 > F([a.canvasX, a.canvasY], [this.selected_group.pos[0] + this.selected_group.size[0], this.selected_group.pos[1] + this.selected_group.size[1]]) * this.ds.scale ? this.selected_group_resizing = !0 : this.selected_group.recomputeInsideNodes());
            e && !this.read_only && this.showSearchBox(a);
            m = !0;
          }
          !d && m && this.allow_dragcanvas && (this.dragging_canvas = !0);
        } else {
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (d) {
                ...
                if (this.connecting_node && (e = this._highlight_input || [0, 0], !this.isOverNodeBox(d, a.canvasX, a.canvasY))) {
                  var m = this.isOverNodeInput(d, a.canvasX, a.canvasY, e);
                  -1 != m && d.inputs[m] ? f.isValidConnection(this.connecting_output.type, d.inputs[m].type) && (this._highlight_input = e) : this._highlight_input = null;
                }
                this.canvas && (A(a.canvasX, a.canvasY, d.pos[0] + d.size[0] - 5, d.pos[1] + d.size[1] - 5, 5, 5) ? this.canvas.style.cursor = "se-resize" : this.canvas.style.cursor = "crosshair");
              } else {
                e = null;
                for (b = 0; b < this.visible_links.length; ++b) {
                  m = this.visible_links[b];
                  var h = m._pos;
              ...
              this.resizing_node && !this.live_mode && (this.resizing_node.size[0] = a.canvasX - this.resizing_node.pos[0], this.resizing_node.size[1] = a.canvasY - this.resizing_node.pos[1], c = Math.max(this.resizing_node.inputs ? this.resizing_node.inputs.length : 0, this.resizing_node.outputs ? this.resizing_node.outputs.length : 0) * f.NODE_SLOT_HEIGHT + (this.resizing_node.widgets ? this.resizing_node.widgets.length : 0) * (f.NODE_WIDGET_HEIGHT + 4) + 4, this.resizing_node.size[1] < c && (this.resizing_node.size[1] = 
              c), this.resizing_node.size[0] < f.NODE_MIN_WIDTH && (this.resizing_node.size[0] = f.NODE_MIN_WIDTH), this.canvas.style.cursor = "se-resize", this.dirty_bgcanvas = this.dirty_canvas = !0);
            }
          }
        }
      }
      ...
      if (1 == a.which) {
        ...
        this.dragging_rectangle) {
          if (this.graph) {
            ...
            var d = Math.abs(this.dragging_rectangle[2]), e = Math.abs(this.dragging_rectangle[3]), m = 0 > this.dragging_rectangle[3] ? this.dragging_rectangle[1] - e : this.dragging_rectangle[1];
            this.dragging_rectangle[0] = 0 > this.dragging_rectangle[2] ? this.dragging_rectangle[0] - d : this.dragging_rectangle[0];
            this.dragging_rectangle[1] = m;
            this.dragging_rectangle[2] = d;
            this.dragging_rectangle[3] = e;
            e = [];
            for (m = 0; m < b.length; ++m) {
              d = b[m], d.getBounding(c), D(this.dragging_rectangle, c) && e.push(d);
            }
  ...
  g.prototype.isOverNodeBox = function(a, b, c) {
    ...
    return A(b, c, a.pos[0] + 2, a.pos[1] + 2 - d, d - 4, d - 4) ? !0 : !1;
  };
  g.prototype.isOverNodeInput = function(a, b, c, d) {
    if (a.inputs) {
      for (var e = 0, f = a.inputs.length; e < f; ++e) {
        var h = a.getConnectionPos(!0, e);
        if (a.horizontal ? A(b, c, h[0] - 5, h[1] - 10, 10, 20) : A(b, c, h[0] - 10, h[1] - 5, 40, 10)) {
  ...
  g.prototype.copyToClipboard = function() {
    ...
    for (d = 0; d < c.length; ++d) {
      if (e = c[d], a.nodes.push(e.clone().serialize()), e.inputs && e.inputs.length) {
        for (b = 0; b < e.inputs.length; ++b) {
          var f = e.inputs[b];
          if (f && null != f.link && (f = this.graph.links[f.link])) {
            var h = this.graph.getNodeById(f.origin_id);
            h && this.selected_nodes[h.id] && a.links.push([h._relative_id, b, e._relative_id, f.target_slot]);
          }
        }
      }
    }
  ...
  g.prototype.processDrop = function(a) {
    ...
    if (c) {
      if ((c.onDropFile || c.onDropData) && (b = a.dataTransfer.files) && b.length) {
        for (var d = 0; d < b.length; d++) {
          var e = a.dataTransfer.files[0], f = e.name;
          g.getFileExtension(f);
          if (c.onDropFile) {
            c.onDropFile(e);
          }
          if (c.onDropData) {
            ...
            h.onload = function(a) {
              c.onDropData(a.target.result, f, e);
            };
            var v = e.type.split("/")[0];
            "text" == v || "" == v ? h.readAsText(e) : "image" == v ? h.readAsDataURL(e) : h.readAsArrayBuffer(e);
          }
        }
      }
  ...
  g.prototype.checkDropItem = function(a) {
    if (a.dataTransfer.files.length) {
      ...
      if (c = f.node_types_by_file_extension[c]) {
        if (c = f.createNode(c.type), c.pos = [a.canvasX, a.canvasY], this.graph.add(c), c.onDropFile) {
          c.onDropFile(b);
        }
      }
    }
      ...
      if (!c.is_selected) {
        ...
        if (c.outputs) {
          for (d = 0; d < c.outputs.length; ++d) {
            var e = c.outputs[d];
            if (e.links) {
              for (var f = 0; f < e.links.length; ++f) {
                this.highlighted_links[e.links[f]] = !0;
              }
            }
          }
        }
  ...
  g.prototype.computeVisibleNodes = function(a, b) {
    ...
    for (var c = 0, d = a.length; c < d; ++c) {
      var e = a[c];
      (!this.live_mode || e.onDrawBackground || e.onDrawForeground) && D(this.visible_area, e.getBounding(H)) && b.push(e);
    }
    return b;
  };
  ...
  g.prototype.drawNode = function(a, b) {
    this.current_node = a;
    var c = a.color || a.constructor.color || f.NODE_DEFAULT_COLOR, d = a.bgcolor || a.constructor.bgcolor || f.NODE_DEFAULT_BGCOLOR;
    if (this.live_mode) {
      ...
      b.globalAlpha = e;
      this.render_shadows ? (b.shadowColor = f.DEFAULT_SHADOW_COLOR, b.shadowOffsetX = 2 * this.ds.scale, b.shadowOffsetY = 2 * this.ds.scale, b.shadowBlur = 3 * this.ds.scale) : b.shadowColor = "transparent";
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          var v = a.getTitle ? a.getTitle() : a.title;
          null != v && (a._collapsed_width = Math.min(a.size[0], b.measureText(v).width + 2 * f.NODE_TITLE_HEIGHT), B[0] = a._collapsed_width, B[1] = 0);
        }
        a.clip_area && (b.save(), b.beginPath(), g == f.BOX_SHAPE ? b.rect(0, 0, B[0], B[1]) : g == f.ROUND_SHAPE ? b.roundRect(0, 0, B[0], B[1], 10) : g == f.CIRCLE_SHAPE && b.arc(0.5 * B[0], 0.5 * B[1], 0.5 * B[0], 0, 2 * Math.PI), b.clip());
        a.has_errors && (d = "red");
        this.drawNodeShape(a, b, B, c, d, a.is_selected, a.mouseOver);
        b.shadowColor = "transparent";
        if (a.onDrawForeground) {
          a.onDrawForeground(b, this, this.canvas);
        }
        b.textAlign = h ? "center" : "left";
        b.font = this.inner_text_font;
        d = 0.6 < this.ds.scale;
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              var l = a.inputs[c];
              b.globalAlpha = e;
              this.connecting_node && !f.isValidConnection(l.type, g.type) && (b.globalAlpha = 0.4 * e);
              ...
              var p = a.getConnectionPos(!0, c, q);
              p[0] -= a.pos[0];
              p[1] -= a.pos[1];
              v < p[1] + 0.5 * f.NODE_SLOT_HEIGHT && (v = p[1] + 0.5 * f.NODE_SLOT_HEIGHT);
              b.beginPath();
              l.type === f.EVENT || l.shape === f.BOX_SHAPE ? h ? b.rect(p[0] - 5 + 0.5, p[1] - 8 + 0.5, 10, 14) : b.rect(p[0] - 6 + 0.5, p[1] - 5 + 0.5, 14, 10) : l.shape === f.ARROW_SHAPE ? (b.moveTo(p[0] + 8, p[1] + 0.5), b.lineTo(p[0] - 4, p[1] + 6 + 0.5), b.lineTo(p[0] - 4, p[1] - 6 + 0.5), b.closePath()) : b.arc(p[0], p[1], 4, 0, 2 * Math.PI);
              b.fill();
              if (d) {
                var t = null != l.label ? l.label : l.name;
                t && (b.fillStyle = f.NODE_TEXT_COLOR, h || l.dir == f.UP ? b.fillText(t, p[0], p[1] - 10) : b.fillText(t, p[0] + 10, p[1] + 5));
              }
            }
          }
          this.connecting_node && (b.globalAlpha = 0.4 * e);
          b.textAlign = h ? "center" : "right";
          b.strokeStyle = "black";
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (l = a.outputs[c], p = a.getConnectionPos(!1, c, q), p[0] -= a.pos[0], p[1] -= a.pos[1], v < p[1] + 0.5 * f.NODE_SLOT_HEIGHT && (v = p[1] + 0.5 * f.NODE_SLOT_HEIGHT), b.fillStyle = l.links && l.links.length ? l.color_on || this.default_connection_color.output_on : l.color_off || this.default_connection_color.output_off, b.beginPath(), l.type === f.EVENT || l.shape === f.BOX_SHAPE ? h ? b.rect(p[0] - 5 + 0.5, p[1] - 8 + 0.5, 10, 14) : b.rect(p[0] - 6 + 0.5, p[1] - 5 + 0.5, 14, 10) : 
              l.shape === f.ARROW_SHAPE ? (b.moveTo(p[0] + 8, p[1] + 0.5), b.lineTo(p[0] - 4, p[1] + 6 + 0.5), b.lineTo(p[0] - 4, p[1] - 6 + 0.5), b.closePath()) : b.arc(p[0], p[1], 4, 0, 2 * Math.PI), b.fill(), b.stroke(), d && (t = null != l.label ? l.label : l.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, h || l.dir == f.DOWN ? b.fillText(t, p[0], p[1] - 8) : b.fillText(t, p[0] - 10, p[1] + 5);
              }
            }
          }
          b.textAlign = "left";
          ...
          if (this.render_collapsed_slots) {
            ...
            if (a.outputs) {
              for (c = 0; c < a.outputs.length; c++) {
                l = a.outputs[c], l.links && l.links.length && (e = l);
              }
            }
            d && (c = 0, d = -0.5 * f.NODE_TITLE_HEIGHT, h && (c = 0.5 * a._collapsed_width, d = -f.NODE_TITLE_HEIGHT), b.fillStyle = "#686", b.beginPath(), l.type === f.EVENT || l.shape === f.BOX_SHAPE ? b.rect(c - 7 + 0.5, d - 4, 14, 8) : l.shape === f.ARROW_SHAPE ? (b.moveTo(c + 8, d), b.lineTo(c + -4, d - 4), b.lineTo(c + -4, d + 4), b.closePath()) : b.arc(c, d, 4, 0, 2 * Math.PI), b.fill());
            e && (c = a._collapsed_width, d = -0.5 * f.NODE_TITLE_HEIGHT, h && (c = 0.5 * a._collapsed_width, d = 0), b.fillStyle = "#686", b.strokeStyle = "black", b.beginPath(), l.type === f.EVENT || l.shape === f.BOX_SHAPE ? b.rect(c - 7 + 0.5, d - 4, 14, 8) : l.shape === f.ARROW_SHAPE ? (b.moveTo(c + 6, d), b.lineTo(c - 6, d - 4), b.lineTo(c - 6, d + 4), b.closePath()) : b.arc(c, d, 4, 0, 2 * Math.PI), b.fill());
          }
        }
  ...
  g.prototype.drawNodeShape = function(a, b, c, d, e, m, h) {
    b.strokeStyle = d;
    b.fillStyle = e;
    e = f.NODE_TITLE_HEIGHT;
    var v = 0.5 > this.ds.scale, q = a._shape || a.constructor.shape || f.ROUND_SHAPE, l = a.constructor.title_mode, p = !0;
    l == f.TRANSPARENT_TITLE ? p = !1 : l == f.AUTOHIDE_TITLE && h && (p = !0);
    x[0] = 0;
    x[1] = p ? -e : 0;
    x[2] = c[0] + 1;
    x[3] = p ? c[1] + e : c[1];
    h = b.globalAlpha;
    b.beginPath();
    q == f.BOX_SHAPE || v ? b.fillRect(x[0], x[1], x[2], x[3]) : q == f.ROUND_SHAPE || q == f.CARD_SHAPE ? b.roundRect(x[0], x[1], x[2], x[3], this.round_radius, q == f.CARD_SHAPE ? 0 : this.round_radius) : q == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0], 0, 2 * Math.PI);
    b.fill();
    ...
    if (p || l == f.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        a.onDrawTitleBar(b, e, c, this.ds.scale, d);
      } else {
        if (l != f.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          p = a.constructor.title_color || d;
          a.flags.collapsed && (b.shadowColor = f.DEFAULT_SHADOW_COLOR);
          if (this.use_gradients) {
            var t = g.gradients[p];
            t || (t = g.gradients[p] = b.createLinearGradient(0, 0, 400, 0), t.addColorStop(0, p), t.addColorStop(1, "#000"));
            b.fillStyle = t;
          } else {
            b.fillStyle = p;
          }
          b.beginPath();
          q == f.BOX_SHAPE || v ? b.rect(0, -e, c[0] + 1, e) : (q == f.ROUND_SHAPE || q == f.CARD_SHAPE) && b.roundRect(0, -e, c[0] + 1, e, this.round_radius, a.flags.collapsed ? this.round_radius : 0);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      if (a.onDrawTitleBox) {
        ...
        q == f.ROUND_SHAPE || q == f.CIRCLE_SHAPE || q == f.CARD_SHAPE ? (v && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * e, -0.5 * e, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.beginPath(), b.arc(0.5 * e, -0.5 * e, 5, 0, 2 * Math.PI), b.fill()) : (v && (b.fillStyle = "black", b.fillRect(0.5 * (e - 10) - 1, -0.5 * (e + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * (e - 10), -0.5 * (e + 10), 10, 10));
      }
      b.globalAlpha = h;
      if (a.onDrawTitleText) {
        a.onDrawTitleText(b, e, c, this.ds.scale, this.title_text_font, m);
      }
      !v && (b.font = this.title_text_font, v = a.getTitle()) && (b.fillStyle = m ? "white" : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "center", h = b.measureText(v), b.fillText(v, e + 0.5 * h.width, f.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(v, e, f.NODE_TITLE_TEXT_Y - e)));
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
    if (m) {
      ...
      l == f.TRANSPARENT_TITLE && (x[1] -= e, x[3] += e);
      b.lineWidth = 1;
      b.globalAlpha = 0.8;
      b.beginPath();
      q == f.BOX_SHAPE ? b.rect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3]) : q == f.ROUND_SHAPE || q == f.CARD_SHAPE && a.flags.collapsed ? b.roundRect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3], 2 * this.round_radius) : q == f.CARD_SHAPE ? b.roundRect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3], 2 * this.round_radius, 2) : q == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0] + 6, 0, 2 * Math.PI);
      b.strokeStyle = "#FFF";
      b.stroke();
      b.strokeStyle = d;
      b.globalAlpha = 1;
  ...
  var E = new Float32Array(4), z = new Float32Array(4), I = new Float32Array(2), J = new Float32Array(2);
    ...
    for (var d = 0, e = c.length; d < e; ++d) {
      ...
      if (g.inputs && g.inputs.length) {
        for (var h = 0; h < g.inputs.length; ++h) {
          var v = g.inputs[h];
          if (v && null != v.link && (v = this.graph.links[v.link])) {
            var q = this.graph.getNodeById(v.origin_id);
            if (null != q) {
              var l = v.origin_slot;
              var p = -1 == l ? [q.pos[0] + 10, q.pos[1] + 10] : q.getConnectionPos(!1, l, I);
              var t = g.getConnectionPos(!0, h, J);
              z[0] = p[0];
              z[1] = p[1];
              z[2] = t[0] - p[0];
              z[3] = t[1] - p[1];
              ...
              if (D(z, E)) {
                var k = q.outputs[l];
                l = g.inputs[h];
                if (k && l && (q = k.dir || (q.horizontal ? f.DOWN : f.RIGHT), l = l.dir || (g.horizontal ? f.UP : f.LEFT), this.renderLink(a, p, t, v, !1, 0, null, q, l), v && v._last_time && 1000 > b - v._last_time)) {
                  k = 2.0 - 0.002 * (b - v._last_time);
                  var n = a.globalAlpha;
                  a.globalAlpha = n * k;
                  this.renderLink(a, p, t, v, !0, k, "white", q, l);
                  a.globalAlpha = n;
                }
              }
            }
  ...
  g.prototype.renderLink = function(a, b, c, d, e, m, h, v, k, l) {
    d && this.visible_links.push(d);
    !h && d && (h = d.color || g.link_type_colors[d.type]);
    ...
    for (var t = 0; t < l; t += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + n, b[1] + r + q, c[0] + u, c[1] + w + q, c[0], c[1] + q);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * n, b[1] + 15 * r + q);
          a.lineTo(c[0] + 15 * u, c[1] + 15 * w + q);
          a.lineTo(c[0], c[1] + q);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), q = b[0], n = b[1], r = c[0], u = c[1], v == f.RIGHT ? q += 10 : n += 10, k == f.LEFT ? r -= 10 : u -= 10, a.lineTo(q, n), a.lineTo(0.5 * (q + r), n), a.lineTo(0.5 * (q + r), u), a.lineTo(r, u), a.lineTo(c[0], c[1]);
          } else {
            return;
          }
        }
    ...
    a.stroke();
    e = this.computeConnectionPoint(b, c, 0.5, v, k);
    d && d._pos && (d._pos[0] = e[0], d._pos[1] = e[1]);
    0.6 <= this.ds.scale && this.highquality_render && k != f.CENTER && (this.render_connection_arrows && (t = this.computeConnectionPoint(b, c, 0.25, v, k), p = this.computeConnectionPoint(b, c, 0.26, v, k), d = this.computeConnectionPoint(b, c, 0.75, v, k), l = this.computeConnectionPoint(b, c, 0.76, v, k), this.render_curved_connections ? (p = -Math.atan2(p[0] - t[0], p[1] - t[1]), l = -Math.atan2(l[0] - d[0], l[1] - d[1])) : l = p = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(t[0], t[1]), 
    a.rotate(p), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(d[0], d[1]), a.rotate(l), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill());
    if (m) {
      for (a.fillStyle = h, t = 0; 5 > t; ++t) {
        m = (0.001 * f.getTime() + 0.2 * t) % 1, e = this.computeConnectionPoint(b, c, m, v, k), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  g.prototype.computeConnectionPoint = function(a, b, c, d, e) {
    d = d || f.RIGHT;
    e = e || f.LEFT;
    var g = F(a, b), h = [a[0], a[1]], v = [b[0], b[1]];
    switch(d) {
      case f.LEFT:
        h[0] += -0.25 * g;
        break;
    ...
    g = 3 * (1 - c) * c * c;
    c *= c * c;
    return [d * a[0] + e * h[0] + g * v[0] + c * b[0], d * a[1] + e * h[1] + g * v[1] + c * b[1]];
  };
  ...
  g.prototype.drawNodeWidgets = function(a, b, c, d) {
    ...
    b += 2;
    var h = f.NODE_WIDGET_HEIGHT, v = 0.5 < this.ds.scale;
    c.save();
    ...
    for (var k = 0; k < g.length; ++k) {
      ...
      switch(l.type) {
        case "button":
          ...
          c.fillRect(15, p, e - 30, h);
          c.strokeRect(15, p, e - 30, h);
          v && (c.textAlign = "center", c.fillStyle = "#AAA", c.fillText(l.name, 0.5 * e, p + 0.7 * h));
          break;
        case "toggle":
          c.textAlign = "left";
          c.strokeStyle = "#666";
          c.fillStyle = "#222";
          c.beginPath();
          c.roundRect(15, b, e - 30, h, 0.5 * h);
          c.fill();
          c.stroke();
          c.fillStyle = l.value ? "#89A" : "#333";
          c.beginPath();
          c.arc(e - 30, p + 0.5 * h, 0.36 * h, 0, 2 * Math.PI);
          c.fill();
          v && (c.fillStyle = "#999", null != l.name && c.fillText(l.name, 30, p + 0.7 * h), c.fillStyle = l.value ? "#DDD" : "#888", c.textAlign = "right", c.fillText(l.value ? l.options.on || "true" : l.options.off || "false", e - 40, p + 0.7 * h));
          break;
        case "slider":
          c.fillStyle = "#222";
          c.fillRect(15, p, e - 30, h);
          var t = l.options.max - l.options.min, n = (l.value - l.options.min) / t;
          c.fillStyle = d == l ? "#89A" : "#678";
          c.fillRect(15, p, n * (e - 30), h);
          c.strokeRect(15, p, e - 30, h);
          l.marker && (t = (l.marker - l.options.min) / t, c.fillStyle = "#AA9", c.fillRect(15 + t * (e - 30), p, 2, h));
          v && (c.textAlign = "center", c.fillStyle = "#DDD", c.fillText(l.name + "  " + Number(l.value).toFixed(3), 0.5 * e, p + 0.7 * h));
          break;
        case "number":
        case "combo":
          c.textAlign = "left";
          ...
          c.fill();
          c.stroke();
          v && (c.fillStyle = "#AAA", c.beginPath(), c.moveTo(31, b + 5), c.lineTo(21, b + 0.5 * h), c.lineTo(31, b + h - 5), c.moveTo(e - 15 - 16, b + 5), c.lineTo(e - 15 - 6, b + 0.5 * h), c.lineTo(e - 15 - 16, b + h - 5), c.fill(), c.fillStyle = "#999", c.fillText(l.name, 35, p + 0.7 * h), c.fillStyle = "#DDD", c.textAlign = "right", "number" == l.type ? c.fillText(Number(l.value).toFixed(void 0 !== l.options.precision ? l.options.precision : 3), e - 30 - 20, p + 0.7 * h) : c.fillText(l.value, 
          e - 30 - 20, p + 0.7 * h));
          break;
        case "string":
        case "text":
          ...
          c.fill();
          c.stroke();
          v && (c.fillStyle = "#999", null != l.name && c.fillText(l.name, 30, p + 0.7 * h), c.fillStyle = "#DDD", c.textAlign = "right", c.fillText(l.value, e - 30, p + 0.7 * h));
          break;
        default:
          l.draw && l.draw(c, a, l, p, h);
      }
      b += h + 4;
    }
    c.restore();
  ...
  g.prototype.processNodeWidgets = function(a, b, c, d) {
    function e(d, e) {
      d.value = e;
      d.property && void 0 !== a.properties[d.property] && (a.properties[d.property] = e);
      d.callback && d.callback(d.value, q, a, b, c);
    }
    if (!a.widgets || !a.widgets.length) {
      return null;
    }
    for (var g = b[0] - a.pos[0], h = b[1] - a.pos[1], k = a.size[0], q = this, l = this.getCanvasWindow(), p = 0; p < a.widgets.length; ++p) {
      var t = a.widgets[p];
      if (t == d || 6 < g && g < k - 12 && h > t.last_y && h < t.last_y + f.NODE_WIDGET_HEIGHT) {
        switch(t.type) {
          case "button":
            if ("mousemove" === c.type) {
              break;
          ...
          case "number":
          case "combo":
            "mousemove" == c.type && "number" == t.type ? (t.value += 0.1 * c.deltaX * (t.options.step || 1), null != t.options.min && t.value < t.options.min && (t.value = t.options.min), null != t.options.max && t.value > t.options.max && (t.value = t.options.max)) : "mousedown" == c.type && ((d = t.options.values) && d.constructor === Function && (d = t.options.values(t, a)), g = 40 > g ? -1 : g > k - 40 ? 1 : 0, "number" == t.type ? (t.value += 0.1 * g * (t.options.step || 1), null != t.options.min && 
            t.value < t.options.min && (t.value = t.options.min), null != t.options.max && t.value > t.options.max && (t.value = t.options.max)) : g ? (l = d.indexOf(t.value) + g, l >= d.length && (l = 0), 0 > l && (l = d.length - 1), t.value = d[l]) : new f.ContextMenu(d, {scale:Math.max(1, this.ds.scale), event:c, className:"dark", callback:function(a, b, c) {
              this.value = a;
              e(this, a);
              q.dirty_canvas = !0;
              return !1;
            ...
            break;
          case "toggle":
            "mousedown" == c.type && (t.value = !t.value, t.callback && setTimeout(function() {
              e(t, t.value);
            }, 20));
            break;
          case "string":
          case "text":
            "mousedown" == c.type && this.prompt("Value", t.value, function(a) {
              this.value = a;
              e(this, a);
            }.bind(t), c);
            break;
          default:
            t.mouse && t.mouse(ctx, c, [g, h], a);
        }
        return t;
      }
    }
  ...
  g.prototype.drawGroups = function(a, b) {
    if (this.graph) {
      ...
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (D(this.visible_area, d._bounding)) {
  ...
  g.onMenuAdd = function(a, b, c, d) {
    function e(a, b) {
      ...
      if (a = f.createNode(a.value)) {
        a.pos = m.convertEventToCanvasOffset(b), m.graph.add(a);
      }
    }
    var m = g.active_canvas, h = m.getCanvasWindow();
    a = f.getNodeTypesCategories(m.filter);
    b = [];
    for (var k in a) {
      a[k] && b.push({value:a[k], content:a[k], has_submenu:!0});
    }
    var q = new f.ContextMenu(b, {event:c, callback:function(a, b, c) {
      a = f.getNodeTypesInCategory(a.value, m.filter);
      b = [];
      for (var d in a) {
        a[d].skip_list || b.push({content:a[d].title, value:a[d].type});
      }
      new f.ContextMenu(b, {event:c, callback:e, parentMenu:q}, h);
      return !1;
    }, parentMenu:d}, h);
    return !1;
  };
  ...
  g.showMenuNodeOptionalInputs = function(a, b, c, d, e) {
    if (e) {
      var m = this;
      ...
      if (b) {
        for (var k in b) {
          ...
          if (q) {
            var l = q[0];
            q[2] && q[2].label && (l = q[2].label);
            l = {content:l, value:q};
            q[1] == f.ACTION && (l.className = "event");
            h.push(l);
          } else {
            h.push(null);
          }
      ...
      if (h.length) {
        return new f.ContextMenu(h, {event:c, callback:function(a, b, c) {
          e && (a.callback && a.callback.call(m, e, a, b, c), a.value && (e.addInput(a.value[0], a.value[1], a.value[2]), e.setDirtyCanvas(!0, !0)));
        }, parentMenu:d, node:e}, a), !1;
      }
    }
  };
  g.showMenuNodeOptionalOutputs = function(a, b, c, d, e) {
    function m(a, b, c) {
      if (e && (a.callback && a.callback.call(h, e, a, b, c), a.value)) {
        if (c = a.value[1], !c || c.constructor !== Object && c.constructor !== Array) {
          ...
          new f.ContextMenu(a, {event:b, callback:m, parentMenu:d, node:e});
          return !1;
        }
      }
    }
    if (e) {
      ...
      if (b) {
        for (var q in b) {
          ...
          if (!l) {
            ...
            if (!e.flags || !e.flags.skip_repeated_outputs || -1 == e.findOutputSlot(l[0])) {
              var p = l[0];
              l[2] && l[2].label && (p = l[2].label);
              p = {content:p, value:l};
              l[1] == f.EVENT && (p.className = "event");
              k.push(p);
            }
          }
        }
      ...
      if (k.length) {
        return new f.ContextMenu(k, {event:c, callback:m, parentMenu:d, node:e}, a), !1;
      }
    }
  };
  g.onShowMenuNodeProperties = function(a, b, c, d, e) {
    if (e && e.properties) {
      var m = g.active_canvas;
      b = m.getCanvasWindow();
      var h = [], k;
      for (k in e.properties) {
        a = void 0 !== e.properties[k] ? e.properties[k] : " ", a = g.decodeHTML(a), h.push({content:"<span class='property_name'>" + k + "</span><span class='property_value'>" + a + "</span>", value:k});
      }
      if (h.length) {
        return new f.ContextMenu(h, {event:c, callback:function(a, b, c, d) {
          e && (b = this.getBoundingClientRect(), m.showEditPropertyValue(e, a.value, {position:[b.left, b.top]}));
  ...
  g.onResizeNode = function(a, b, c, d, e) {
    e && (e.size = e.computeSize(), e.setDirtyCanvas(!0, !0));
  };
  g.prototype.showLinkMenu = function(a, b) {
    var c = this;
    console.log(a.data);
    new f.ContextMenu(["Delete"], {event:b, title:null != a.data ? a.data.constructor.name : null, callback:function(b) {
      switch(b) {
        case "Delete":
  ...
  g.onShowPropertyEditor = function(a, b, c, d, e) {
    function f() {
      var b = q.value;
    ...
    var l = d = -20;
    c && (d -= c.left, l -= c.top);
    event ? (k.style.left = event.clientX + d + "px", k.style.top = event.clientY + l + "px") : (k.style.left = 0.5 * b.width + d + "px", k.style.top = 0.5 * b.height + l + "px");
    k.querySelector("button").addEventListener("click", f);
    b.parentNode.appendChild(k);
  };
  g.prototype.prompt = function(a, b, c, d) {
    var e = this;
    a = a || "";
    var f = !1, h = document.createElement("div");
    ...
    var q = -20, l = -20;
    b && (q -= b.left, l -= b.top);
    d ? (h.style.left = d.clientX + q + "px", h.style.top = d.clientY + l + "px") : (h.style.left = 0.5 * a.width + q + "px", h.style.top = 0.5 * a.height + l + "px");
  ...
  g.prototype.showSearchBox = function(a) {
    function b(b) {
      if (b) {
        if (e.onSearchBoxSelection) {
          e.onSearchBoxSelection(b, a, n);
        } else {
          var c = f.searchbox_extras[b.toLowerCase()];
          c && (b = c.type);
          if (b = f.createNode(b)) {
            b.pos = n.convertEventToCanvasOffset(a), n.graph.add(b);
          }
          if (c && c.data) {
    ...
    function d() {
      ...
      if (c) {
        if (e.onSearchBox) {
          ...
          d = 0;
          c = c.toLowerCase();
          for (h in f.searchbox_extras) {
            var m = f.searchbox_extras[h];
            if (-1 !== m.desc.toLowerCase().indexOf(c) && (a(m.desc, "searchbox_extra"), -1 !== g.search_limit && d++ > g.search_limit)) {
              break;
            }
          }
          if (Array.prototype.filter) {
            for (m = Object.keys(f.registered_node_types).filter(function(a) {
              return -1 !== a.toLowerCase().indexOf(c);
            }), h = 0; h < m.length && !(a(m[h]), -1 !== g.search_limit && d++ > g.search_limit); h++) {
            }
          } else {
            for (h in f.registered_node_types) {
              if (-1 != h.indexOf(c) && (a(h), -1 !== g.search_limit && d++ > g.search_limit)) {
                break;
              }
            }
          }
    ...
    var e = this, m = document.createElement("div");
    ...
    e.search_box = m;
    var k = m.querySelector(".helper"), q = null, l = null, p = null, t = m.querySelector("input");
    ...
    var n = g.active_canvas, r = n.canvas, u = r.getBoundingClientRect(), w = -20, x = -20;
    u && (w -= u.left, x -= u.top);
    a ? (m.style.left = a.clientX + w + "px", m.style.top = a.clientY + x + "px") : (m.style.left = 0.5 * r.width + w + "px", m.style.top = 0.5 * r.height + x + "px");
  ...
  g.prototype.showEditPropertyValue = function(a, b, c) {
    ...
    if (a && void 0 !== a.properties[b]) {
      ...
      "object" == f && a.properties[b].length && (f = "array");
      var h = null;
      a.getPropertyInfo && (h = a.getPropertyInfo(b));
      if (a.properties_info) {
        for (var g = 0; g < a.properties_info.length; ++g) {
          if (a.properties_info[g].name == b) {
            h = a.properties_info[g];
            break;
          }
        }
      }
      void 0 !== h && null !== h && h.type && (f = h.type);
      var k = "";
      if ("string" == f || "number" == f || "array" == f) {
        k = "<input autofocus type='text' class='value'/>";
      } else {
        if ("enum" == f && h.values) {
          k = "<select autofocus type='text' class='value'>";
          for (g in h.values) {
            var l = h.values.constructor === Array ? h.values[g] : g;
            k += "<option value='" + l + "' " + (l == a.properties[b] ? "selected" : "") + ">" + h.values[g] + "</option>";
          }
          k += "</select>";
        } else {
          if ("boolean" == f) {
      ...
      var p = this.createDialog("<span class='name'>" + b + "</span>" + k + "<button>OK</button>", c);
      if ("enum" == f && h.values) {
  ...
  g.onMenuNodeCollapse = function(a, b, c, d, e) {
    e.collapse();
  };
  g.onMenuNodePin = function(a, b, c, d, e) {
    e.pin();
  };
  g.onMenuNodeMode = function(a, b, c, d, e) {
  ...
  g.onMenuNodeColors = function(a, b, c, d, e) {
    if (!e) {
      throw "no node for color";
    }
    b = [];
    b.push({value:null, content:"<span style='display: block; padding-left: 4px;'>No color</span>"});
    for (var k in g.node_colors) {
      a = g.node_colors[k], a = {value:k, content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid " + a.color + "; background-color:" + a.bgcolor + "'>" + k + "</span>"}, b.push(a);
    }
    new f.ContextMenu(b, {event:c, callback:function(a) {
      e && ((a = a.value ? g.node_colors[a.value] : null) ? e.constructor === f.LGraphGroup ? e.color = a.groupcolor : (e.color = a.color, e.bgcolor = a.bgcolor) : (delete e.color, delete e.bgcolor), e.setDirtyCanvas(!0, !0));
    }, parentMenu:d, node:e});
    return !1;
  };
  g.onMenuNodeShapes = function(a, b, c, d, e) {
    if (!e) {
  ...
  g.onMenuNodeRemove = function(a, b, c, d, e) {
    if (!e) {
      throw "no node passed";
    }
    !1 !== e.removable && (e.graph.remove(e), e.setDirtyCanvas(!0, !0));
  };
  g.onMenuNodeClone = function(a, b, c, d, e) {
  ...
  g.prototype.processContextMenu = function(a, b) {
    var c = this, d = g.active_canvas.getCanvasWindow(), e = null, k = {event:b, callback:function(b, d, e) {
      if (b) {
    ...
    a && (h = a.getSlotInPosition(b.canvasX, b.canvasY), g.active_node = a);
    h ? (e = [], h && h.output && h.output.links && h.output.links.length && e.push({content:"Disconnect Links", slot:h}), b = h.input || h.output, e.push(b.locked ? "Cannot remove" : {content:"Remove Slot", slot:h}), e.push(b.nameLocked ? "Cannot rename" : {content:"Rename Slot", slot:h}), k.title = (h.input ? h.input.type : h.output.type) || "*", h.input && h.input.type == f.ACTION && (k.title = "Action"), h.output && h.output.type == f.EVENT && (k.title = "Event")) : a ? e = this.getNodeMenuOptions(a) : 
  ...
  u.Editor = f.Editor = G;
  G.prototype.addMiniWindow = function(a, b) {
    var c = document.createElement("div");
    c.className = "litegraph miniwindow";
    c.innerHTML = "<canvas class='graphcanvas' width='" + a + "' height='" + b + "' tabindex=10></canvas>";
    a = c.querySelector("canvas");
    var d = this, e = new g(a, this.graph);
    e.show_info = !1;
    e.background_image = "assets/img/grid.png";
    e.scale = 0.25;
    e.allow_dragnodes = !1;
    e.allow_interaction = !1;
    e.render_shadows = !1;
    e.max_zoom = 0.25;
    this.miniwindow_graphcanvas = e;
    e.onClear = function() {
      e.scale = 0.25;
      e.allow_dragnodes = !1;
      e.allow_interaction = !1;
    };
    e.onRenderBackground = function(a, b) {
      b.strokeStyle = "#567";
      a = d.graphcanvas.convertOffsetToCanvas([0, 0]);
      var c = d.graphcanvas.convertOffsetToCanvas([d.graphcanvas.canvas.width, d.graphcanvas.canvas.height]);
      a = this.convertCanvasToOffset(a);
      c = this.convertCanvasToOffset(c);
      b.lineWidth = 1;
      b.strokeRect(Math.floor(a[0]) + 0.5, Math.floor(a[1]) + 0.5, Math.floor(c[0] - a[0]), Math.floor(c[1] - a[1]));
    };
    c.style.position = "absolute";
    c.style.top = "4px";
    c.style.right = "4px";
    a = document.createElement("div");
    a.className = "corner-button";
    a.innerHTML = "X";
    ...
    c.appendChild(a);
    this.root.querySelector(".content").appendChild(c);
  };
})(this);
...
(function(u) {
  ...
  function y() {
    ...
    Object.defineProperty(this.properties, "name", {get:function() {
      return k.name_in_graph;
    }, set:function(g) {
      "" != g && g != k.name_in_graph && "enabled" != g && (k.graph && (k.name_in_graph ? k.graph.renameInput(k.name_in_graph, g) : k.graph.addInput(g, k.properties.type)), k.name_widget.value = g, k.name_in_graph = g);
    }, enumerable:!0});
    Object.defineProperty(this.properties, "type", {get:function() {
      return k.outputs[0].type;
    }, set:function(g) {
      "event" == g && (g = w.EVENT);
      k.outputs[0].type = g;
      k.name_in_graph && k.graph.changeInputType(k.name_in_graph, k.outputs[0].type);
      k.type_widget.value = g;
    }, enumerable:!0});
    this.name_widget = this.addWidget("text", "Name", this.properties.name, function(g) {
      g && (k.properties.name = g);
    });
  ...
  function r() {
    ...
    Object.defineProperty(this.properties, "name", {get:function() {
      ...
      "" != g && g != k.name_in_graph && (k.name_in_graph ? k.graph.renameOutput(k.name_in_graph, g) : k.graph.addOutput(g, k.properties.type), k.name_widget.value = g, k.name_in_graph = g);
    }, enumerable:!0});
    Object.defineProperty(this.properties, "type", {get:function() {
      return k.inputs[0].type;
    }, set:function(g) {
      if ("action" == g || "event" == g) {
        g = w.ACTION;
      }
      k.inputs[0].type = g;
      k.name_in_graph && k.graph.changeOutputType(k.name_in_graph, k.inputs[0].type);
      k.type_widget.value = g || "";
    }, enumerable:!0});
    this.name_widget = this.addWidget("text", "Name", this.properties.name, function(g) {
      g && (k.properties.name = g);
  ...
  var w = u.LiteGraph;
  n.title = "Subgraph";
  n.desc = "Graph inside a node";
  n.title_color = "#334";
  n.prototype.onGetInputs = function() {
    return [["enabled", "boolean"]];
  };
  n.prototype.onDrawTitle = function(k) {
    if (!this.flags.collapsed) {
      k.fillStyle = "#555";
      var g = w.NODE_TITLE_HEIGHT, n = this.size[0] - g;
      k.fillRect(n, -g, g, g);
      k.fillStyle = "#333";
      k.beginPath();
      k.moveTo(n + 0.2 * g, 0.6 * -g);
      k.lineTo(n + 0.8 * g, 0.6 * -g);
      k.lineTo(n + 0.5 * g, 0.3 * -g);
      k.fill();
    }
  };
  n.prototype.onDblClick = function(k, g, n) {
    var r = this;
    setTimeout(function() {
      n.openSubgraph(r.subgraph);
    }, 10);
  };
  n.prototype.onMouseDown = function(k, g, n) {
    if (!this.flags.collapsed && g[0] > this.size[0] - w.NODE_TITLE_HEIGHT && 0 > g[1]) {
      var r = this;
      setTimeout(function() {
        n.openSubgraph(r.subgraph);
      }, 10);
  ...
  n.prototype.onAction = function(k, g) {
    this.subgraph.onAction(k, g);
  };
  n.prototype.onExecute = function() {
    if (this.enabled = this.getInputOrProperty("enabled")) {
      if (this.inputs) {
        for (var k = 0; k < this.inputs.length; k++) {
          var g = this.inputs[k], n = this.getInputData(k);
          this.subgraph.setInputData(g.name, n);
        }
      }
      this.subgraph.runStep();
      if (this.outputs) {
        for (k = 0; k < this.outputs.length; k++) {
          n = this.subgraph.getOutputData(this.outputs[k].name), this.setOutputData(k, n);
        }
      }
    }
  };
  n.prototype.sendEventToAllNodes = function(k, g, n) {
    this.enabled && this.subgraph.sendEventToAllNodes(k, g, n);
  };
  n.prototype.onSubgraphTrigger = function(k, g) {
    k = this.findOutputSlot(k);
    -1 != k && this.triggerSlot(k);
  };
  n.prototype.onSubgraphNewInput = function(k, g) {
    -1 == this.findInputSlot(k) && this.addInput(k, g);
  };
  n.prototype.onSubgraphRenamedInput = function(k, g) {
    k = this.findInputSlot(k);
    -1 != k && (this.getInputInfo(k).name = g);
  };
  n.prototype.onSubgraphTypeChangeInput = function(k, g) {
    k = this.findInputSlot(k);
    -1 != k && (this.getInputInfo(k).type = g);
  };
  n.prototype.onSubgraphRemovedInput = function(k) {
    k = this.findInputSlot(k);
    -1 != k && this.removeInput(k);
  };
  n.prototype.onSubgraphNewOutput = function(k, g) {
    -1 == this.findOutputSlot(k) && this.addOutput(k, g);
  };
  n.prototype.onSubgraphRenamedOutput = function(k, g) {
    k = this.findOutputSlot(k);
    -1 != k && (this.getOutputInfo(k).name = g);
  };
  n.prototype.onSubgraphTypeChangeOutput = function(k, g) {
    k = this.findOutputSlot(k);
    -1 != k && (this.getOutputInfo(k).type = g);
  };
  n.prototype.onSubgraphRemovedOutput = function(k) {
    k = this.findInputSlot(k);
    -1 != k && this.removeOutput(k);
  };
  n.prototype.getExtraMenuOptions = function(k) {
    var g = this;
    return [{content:"Open", callback:function() {
      k.openSubgraph(g.subgraph);
    }}];
  };
  n.prototype.onResize = function(k) {
    k[1] += 20;
  };
  n.prototype.serialize = function() {
    var k = LGraphNode.prototype.serialize.call(this);
    k.subgraph = this.subgraph.serialize();
    return k;
  };
  n.prototype.clone = function() {
    var k = w.createNode(this.type), g = this.serialize();
    delete g.id;
    delete g.inputs;
    delete g.outputs;
    k.configure(g);
  ...
  w.Subgraph = n;
  w.registerNodeType("graph/subgraph", n);
  y.title = "Input";
  y.desc = "Input of the graph";
  y.prototype.getTitle = function() {
    return this.flags.collapsed ? this.properties.name : this.title;
  };
  y.prototype.onAction = function(k, g) {
    this.properties.type == w.EVENT && this.triggerSlot(0, g);
  };
  y.prototype.onExecute = function() {
    var k = this.graph.inputs[this.properties.name];
    k && this.setOutputData(0, k.value);
  };
  y.prototype.onRemoved = function() {
    this.name_in_graph && this.graph.removeInput(this.name_in_graph);
  };
  w.GraphInput = y;
  w.registerNodeType("graph/input", y);
  r.title = "Output";
  ...
  r.prototype.onAction = function(k, g) {
    this.properties.type == w.ACTION && this.graph.trigger(this.properties.name, g);
  };
  ...
  w.GraphOutput = r;
  w.registerNodeType("graph/output", r);
})(this);
